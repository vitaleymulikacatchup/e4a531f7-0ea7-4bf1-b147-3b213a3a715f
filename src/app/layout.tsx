...
export const metadata: Metadata = {
  title: "AutoElite - Premium Cars & Expert Service | Find Your Dream Vehicle",
  description: "Discover premium vehicles at AutoElite. Quality assurance, flexible financing, extended warranties. Browse luxury sedans, SUVs, sports cars & more. Schedule test drive today.",
  keywords: "car dealership, premium vehicles, auto sales, car financing, luxury cars, SUV, sedan, sports car, automotive service",
  metadataBase: new URL("https://autoelite.com"),
  alternates: {
    canonical: "https://autoelite.com"
  },
  openGraph: {
    title: "AutoElite - Premium Cars & Expert Service",
    description: "Find your perfect vehicle at AutoElite. Quality assurance, competitive pricing, flexible financing options.",
  ...
  twitter: {
    ...
    title: "AutoElite - Premium Cars & Expert Service",
    description: "Discover premium vehicles with quality assurance and flexible financing"
  },
  robots: {
    index: true,
    follow: true
